...
function joinCoupleDisplayNames(coupleNames: Record<string, unknown>): string {
    const brideName =
        typeof coupleNames.brideName === "string"
            ? coupleNames.brideName.trim()
            : "";
    const groomName =
        typeof coupleNames.groomName === "string"
            ? coupleNames.groomName.trim()
            : "";
    const separator =
        typeof coupleNames.separator === "string" &&
        coupleNames.separator.trim()
            ? coupleNames.separator.trim()
            : "&";
    const order = coupleNames.nameOrder as
        | "bride-first"
        | "groom-first"
        | undefined;
