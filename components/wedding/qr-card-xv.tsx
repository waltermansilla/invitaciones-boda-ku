...
export default function QRCardXV({
  ...
  return (
    ...
    >
      ...
      {/* Content */}
      <div style={{ position: "relative", zIndex: 10, display: "flex", flexDirection: "column", alignItems: "center", padding: "0 40px", maxWidth: "400px", textAlign: "center" }}>
        {/* Names - two lines */}
        <div style={{ marginBottom: "24px", display: "flex", flexDirection: "column", alignItems: "center", gap: "4px" }}>
          <span style={{ fontSize: "clamp(16px, 4vw, 20px)", fontFamily: names.font1 || "'Cormorant Garamond', serif", letterSpacing: "0.15em", textTransform: "uppercase", color: textColor, opacity: 0.7 }}>
            {names.text1}
          </span>
          <span style={{ fontSize: "clamp(36px, 9vw, 48px)", fontFamily: names.font2 || "'Great Vibes', cursive", color: textColor }}>
            {names.text2}
          </span>
        </div>
        ...
        {/* QR */}
        <div style={{ borderRadius: "12px", padding: "10px", backgroundColor: "rgba(255,255,255,0.6)", border: `1px solid ${accentColor}30` }}>
          <QRCodeCanvas
            value={qrUrl}
            size={140}
            fgColor={qrFgColor}
