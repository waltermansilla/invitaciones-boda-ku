...
import { Copy, Check, Gift, CreditCard, Heart, Star, Sparkles, HandHeart, DollarSign } from "lucide-react"
...
export default function GiftCardSection({ icon, title, description, button, modal }: GiftCardSectionProps) {
