 ...
 *
 * ─────────────────────────────────────────────── */
const BRAND_NAME = "momento unico"
const BRAND_FONT = "font-serif"
const BRAND_SIZE = "text-base"
...
function InstagramIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={ICON_SIZE} height={ICON_SIZE} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
...
function WhatsAppIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" width={ICON_SIZE} height={ICON_SIZE} viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
...
export default function FooterSection() {
  return (
    <footer className="bg-primary px-6 py-16 text-center">
      ...
      >
        {BRAND_ICON && (
          <img src={BRAND_ICON} alt="" className="h-5 w-5 opacity-60" />
        )}
        {BRAND_NAME}
      </Link>
    </footer>
